    ...
    async def create_categories_and_channels(self):
        with open('channels.json', 'r') as f: 
            ...
            for cat in categories:
                category = await self.guild.create_category(cat['category_name'])
                channels = cat['channels']
                for chan in channels:
                    await self.guild.create_text_channel(chan['channel_name'], category=category)
    ...
    async def create_roles(self):
        with open('roles.json', 'r') as f: 
            ...
            for role in roles:
                ...
                await self.guild.create_role(name=role['role_name'], permissions=perms)
